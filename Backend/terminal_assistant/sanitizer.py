...
# This file handles sanitizer.
import re


ANSI_ESCAPE = re.compile(
    # OSC sequences end at BEL or ESC + backslash.
    r"(?:\x1B\][^\x07\x1B]*(?:\x07|\x1B\\))|"
    r"(?:\x1B[@-_][0-?]*[ -/]*[@-~])|"
    # Application keypad mode is a two-byte escape emitted beside Kali prompts.
    r"(?:\x1B[=>])"
)
# Zsh syntax highlighting often rewinds the cursor and repaints the entire command in colour.
